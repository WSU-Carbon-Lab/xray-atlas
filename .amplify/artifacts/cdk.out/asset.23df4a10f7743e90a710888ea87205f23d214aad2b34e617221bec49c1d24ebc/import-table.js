...
exports.sanitizeTableProperties =
  exports.getImportedTableComparisonProperties =
  exports.getExpectedTableProperties =
  exports.validateImportedTableProperties =
  exports.importTable =
    void 0;
...
const importTable = async (createTableInput) => {
  ...
  const expectedTableProperties = (0, exports.getExpectedTableProperties)(
    createTableInput,
  );
  const importedTableProperties = (0,
  exports.getImportedTableComparisonProperties)(describeTableResult.Table);
  (0, exports.validateImportedTableProperties)(
    importedTableProperties,
...
const validateImportedTableProperties = (
  importedTableProperties,
  expectedTableProperties,
) => {
  const errors = [];
  ...
  const sanitizedImportedTableProperties = (0, exports.sanitizeTableProperties)(
    importedTableProperties,
  );
  const sanitizedExpectedTableProperties = (0, exports.sanitizeTableProperties)(
    expectedTableProperties,
  );
  assertEqual(
  ...
  assertEqual(
    "KeySchema",
    sanitizedImportedTableProperties.KeySchema,
    sanitizedExpectedTableProperties.KeySchema,
  );
  assertEqual(
  ...
  assertEqual(
    "SSEDescription",
    sanitizedImportedTableProperties.SSEDescription,
    sanitizedExpectedTableProperties.SSEDescription,
  );
  assertEqual(
...
const getExpectedTableProperties = (createTableInput) => {
  return {
    ...
    DeletionProtectionEnabled:
      getExpectedDeletionProtectionEnabled(createTableInput),
  };
};
...
const getExpectedGlobalSecondaryIndexes = (createTableInput) => {
  var _a;
  return (_a = createTableInput.GlobalSecondaryIndexes) === null ||
    _a === void 0
    ? void 0
    : _a.map((gsi) => {
...
const getExpectedSSEDescription = (createTableInput) => {
  return createTableInput.SSESpecification &&
    createTableInput.SSESpecification.Enabled
    ? {
...
const getImportedTableComparisonProperties = (importedTable) => {
  return {
    ...
    GlobalSecondaryIndexes:
      getGlobalSecondaryIndexesForComparison(importedTable),
    ...
    DeletionProtectionEnabled:
      getDeletionProtectionEnabledForComparison(importedTable),
  };
};
exports.getImportedTableComparisonProperties =
...
const getAttributeDefinitionsForComparison = (importedTable) => {
  var _a;
  return (_a = importedTable.AttributeDefinitions) === null || _a === void 0
    ? void 0
    : _a.map((attributeDefinition) => ({
...
const getKeySchemaForComparison = (importedTable) => {
  var _a;
  return (_a = importedTable.KeySchema) === null || _a === void 0
    ? void 0
    : _a.map((key) => ({
...
const getGlobalSecondaryIndexesForComparison = (importedTable) => {
  var _a;
  return (_a = importedTable.GlobalSecondaryIndexes) === null || _a === void 0
    ? void 0
    : _a.map((gsi) => {
        var _a;
        return {
          ...
          KeySchema:
            (_a = gsi.KeySchema) === null || _a === void 0
              ? void 0
              : _a.map((key) => ({
                  AttributeName: key.AttributeName,
                  KeyType: key.KeyType,
...
const getProvisionedThroughputForComparison = (importedTable) => {
  return importedTable.ProvisionedThroughput
    ? {
        ReadCapacityUnits:
          importedTable.ProvisionedThroughput.ReadCapacityUnits,
        WriteCapacityUnits:
          importedTable.ProvisionedThroughput.WriteCapacityUnits,
      }
    : undefined;
};
const getStreamSpecificationForComparison = (importedTable) => {
  ...
  return importedTable.StreamSpecification
    ? {
        StreamEnabled:
          (_a = importedTable.StreamSpecification) === null || _a === void 0
            ? void 0
            : _a.StreamEnabled,
        StreamViewType:
          (_b = importedTable.StreamSpecification) === null || _b === void 0
            ? void 0
            : _b.StreamViewType,
      }
    : undefined;
...
const sanitizeTableProperties = (tableProperties) => {
  const tablePropertiesUndefinedRemoved = JSON.parse(
  ...
  if (tablePropertiesUndefinedRemoved.AttributeDefinitions) {
    tablePropertiesUndefinedRemoved.AttributeDefinitions.sort((a, b) => {
      var _a, _b;
      return (
        (_a = a.AttributeName) !== null && _a !== void 0 ? _a : ""
      ).localeCompare(
        (_b = b.AttributeName) !== null && _b !== void 0 ? _b : "",
      );
    });
  }
  const sortKeySchema = (a, b) => {
    var _a, _b;
    return (
      (_a = a.AttributeName) !== null && _a !== void 0 ? _a : ""
    ).localeCompare((_b = b.AttributeName) !== null && _b !== void 0 ? _b : "");
  };
  ...
  if (tablePropertiesUndefinedRemoved.GlobalSecondaryIndexes) {
    tablePropertiesUndefinedRemoved.GlobalSecondaryIndexes.sort((a, b) => {
      var _a, _b;
      return (
        (_a = a.IndexName) !== null && _a !== void 0 ? _a : ""
      ).localeCompare((_b = b.IndexName) !== null && _b !== void 0 ? _b : "");
    });
