...
Based on [Apple Human Interface Guidelines: Typography](https://developer.apple.com/design/human-interface-guidelines/typography)

Typography is fundamental to great design - it should be legible, accessible, and aesthetically pleasing.
...
<span className="font-mono">
  1.23 x 10<sup className="text-xs">-4</sup>
</span>
```
...
<span>theta (degrees)</span>
<span>lambda = 1.54 A</span>
...
- [Typography Overview](https://developer.apple.com/design/human-interface-guidelines/typography)
- [Dynamic Type](https://developer.apple.com/design/human-interface-guidelines/typography#Dynamic-Type)
- [Font Weights and Styles](https://developer.apple.com/design/human-interface-guidelines/typography#Font-weights-and-styles)
- [System Fonts](https://developer.apple.com/design/human-interface-guidelines/typography#System-fonts)
