...
export function FormField({
  ...
  const baseInputClasses =
    "focus:border-accent focus:ring-accent/20 w-full rounded-lg border bg-white px-4 py-2 text-gray-900 focus:outline-none focus:ring-2 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100";
