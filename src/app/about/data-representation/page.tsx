      ...
      <div className="mx-auto max-w-3xl space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <section className="border-border bg-surface rounded-lg border p-4">
            ...
            <p className="text-muted text-sm">
              Facility, instrument, edge, geometry, and detection metadata
              provide context required for interpretation and comparison.
            </p>
          </section>
          <section className="border-border bg-surface rounded-lg border p-4">
            <h2 className="text-foreground mb-2 text-lg font-semibold">
          ...
          <section className="border-border bg-surface rounded-lg border p-4">
            ...
            <p className="text-muted text-sm">
              Contributor and citation context support reproducibility and
              proper credit for data reuse.
            </p>
          </section>
        </div>
        <p className="text-muted">
