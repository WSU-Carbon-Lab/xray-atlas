...
export default function BrowsePage() {
  ...
  // Use search if there's a query, otherwise use getAllPaginated
          ...
          >
            {Array.from({ length: itemsPerPage }).map((_, i) => (
              <div
                ...
                className={
                  viewMode === "spacious"
                    ? "h-64 animate-pulse rounded-2xl border border-gray-200/40 bg-white shadow-lg dark:border-gray-700/40 dark:bg-gray-800"
                    : "h-32 animate-pulse rounded-xl border border-gray-200 bg-white p-4 shadow-lg dark:border-gray-700 dark:bg-gray-800"
                }
              />
            ))}
          </div>
              ...
              >
                {molecules.map((molecule) => {
                  ...
                  return (
                    ...
                    >
                      <MoleculeComponent molecule={displayMolecule} />
                    </Link>
                  );
                })}
              </div>
            ...
            {totalPages > 1 && (
              <div className="mt-8 flex items-center justify-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {/* Page number buttons for first few and last pages */}
                  {totalPages <= 7 ? (
