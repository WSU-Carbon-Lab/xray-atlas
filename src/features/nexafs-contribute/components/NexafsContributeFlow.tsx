...
export type NexafsContributeFlowProps = {
  ...
  handleDatasetRename: (id: string, name: string) => void;
  ...
  calibrationOptions: { id: string; name: string; description: string | null }[];
      ...
      if (e.dataTransfer?.types.includes("Files")) {
        ...
        if (e.dataTransfer?.items && e.dataTransfer.items.length > 0) {
          ...
          if (fileTypes.length > 0) {
            ...
            setDraggedFileType(uniqueTypes.length === 1 ? uniqueTypes[0]! : "mixed");
          }
        }
      }
    };
            ...
            <div className="flex items-center justify-end">
              <Tooltip delay={0}>
                ...
                <Tooltip.Content className="bg-foreground text-background rounded-lg px-3 py-2 shadow-lg">
                  Submit all datasets for review. Files will remain private until
