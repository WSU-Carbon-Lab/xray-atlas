...
![Example spectrum of C60 choosing the index of refraction channels](./blog-assets/beta-kramers-kronig/kk-calculation.png)
...
![In-browser Kramers-Kronig delta versus the kkcalc2 reference for PC61BM at the carbon K-edge, with the residual shown in the lower panel.](./blog-assets/beta-kramers-kronig/kk-browser-vs-kkcalc2.svg)
