...
![Screenshot of the users contribution statistics](./blog-assets/beta-users/user-stats.png)
...
![Screenshot of the attribution settings page, showing the default behaviour for pending attributions.](./blog-assets/beta-users/account-prefs.png)
...
toward persistent identifiers for hosted datasets; we will write about that
once it is concrete.
