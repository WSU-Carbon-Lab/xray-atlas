...
![Diagram of the new architecture, showing the new platform with a backend relational
database, better user authentication, and a more flexible data model.](./blog-assets/new-architecture.png)
