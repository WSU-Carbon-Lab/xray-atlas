...
![Screenshot of the molecule registration form, showing the search options and the molecule sketcher.](./blog-assets/beta-molecules/molecule-upload1.png)
...
![Screenshot of the molecule registration form, showing the fine tuning options and the molecule structure upload options.](./blog-assets/beta-molecules/molecule-upload2.png)
